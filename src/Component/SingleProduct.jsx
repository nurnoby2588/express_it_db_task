    ...
    return (
        <div>
            
            {
                ...
                </div> : <div className='mx-auto w-2/6 h-2/6 p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 grid grid-cols-2 gap-4'>
                <div>
